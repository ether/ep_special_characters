exports.aceInitInnerdocbodyHead = function (hook_name, args, cb) {
  args.iframeHTML.push('<link rel="stylesheet" type="text/css" href="/static/plugins/ep_special_characters/static/css/ace.css"/>');
  return cb();
};

exports.aceAttribsToClasses = function (hook_name, args, cb) {
  if (args.key == 'specialCharacters' && args.value != '') return cb([`specialCharacters:${args.value}`]);
};
...
exports.cleanEmbedCode = function (orig) {
  ...
  if (!res) {
    return "<img src='/static/plugins/ep_special_characters/static/html/invalid.png'>";
  }
